    ...
    def train(self):
        ...
        for epoch in range(100):
            ...
            if avg_val_loss < best_loss:
                ...
                model_path = 'classifier_intensity_best.pth'
...
if __name__ == "__main__":
    ...
    model = GaussianConvEncoderClf(in_channels=1, latent_dim=512, num_vars=2)
    model.to("cuda:0")
    
    # init dataset
    train_loader = get_dataloader_morphomnist(path="../datasets/morphomnist_data", batch_size=64, split_set="train", shard=0, num_shards=1)
    val_loader = get_dataloader_morphomnist(path="../datasets/morphomnist_data", batch_size=64, split_set="val", shard=0, num_shards=1)
