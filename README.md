...
This fork contains the source code for the implementation of "Causal Diffusion Autoencoders: Toward Counterfactual Generation via Diffusion Probabilistic Models" (ECAI 2024). The original code lacked a clear README file, making it unclear how to obtain the desired dataset and where to find the appropriate files. This fork aims to address those issues. This code improves upon the version of the original source code that was the latest version in Summer 2025, namely commit `4e9f669`.
